...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (is_visible)
    {
        ...
        ImVec4 normalBorderColor = ImVec4(153 / 255.0f, 102 / 255.0f, 204 / 255.0f, 1.0f); // Purple border
        ImVec4 hoveredBorderColor = ImVec4(178 / 255.0f, 102 / 255.0f, 255 / 255.0f, 1.0f); // Light purple hover
        ImVec4 heldBorderColor = ImVec4(153 / 255.0f, 102 / 255.0f, 204 / 255.0f, 1.0f); // Purple border
        ...
        ImVec4 checkedFillColorTop = ImVec4(178 / 255.0f, 102 / 255.0f, 255 / 255.0f, 1.0f); // Purple checked
        ImVec4 checkedFillColorBottom = ImVec4(153 / 255.0f, 77 / 255.0f, 255 / 255.0f, 1.0f); // Darker purple checked

        ImVec4 uncheckedTextColor = ImVec4(112 / 255.0f, 112 / 255.0f, 113 / 255.0f, 1.0f);
        ImVec4 checkedTextColor = ImVec4(204 / 255.0f, 153 / 255.0f, 255 / 255.0f, 1.0f); // Light purple text when checked
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const float arrow_size = (flags & ImGuiComboFlags_NoArrowButton) ? 0.0f : (g.FontSize * 0.8f + style.FramePadding.y * 0.6f);
    const ImVec2 label_size = CalcTextSize(label, NULL, true);
    ...
    // Make combo box height smaller - use font size with minimal padding
    const float combo_height = g.FontSize + style.FramePadding.y * 0.8f;
    const ImRect bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(w, combo_height));
    ...
    struct ComboBorderAnimState { ImVec4 currentBorderColor = ImVec4(153 / 255.0f, 102 / 255.0f, 204 / 255.0f, 1.0f); float animationSpeed = 2.0f; };
    ...
    if (!(flags & ImGuiComboFlags_NoPreview))
    {
        ...
        ImVec4 hoveredBorderColor = ImVec4(178 / 255.0f, 102 / 255.0f, 255 / 255.0f, 1.0f); // Light purple hover
        ImVec4 activeBorderColor = ImVec4(153 / 255.0f, 102 / 255.0f, 204 / 255.0f, 1.0f); // Purple border
    ...
    if (preview_value != NULL && !(flags & ImGuiComboFlags_NoPreview))
    {
        ...
        // Use ellipsis for long text to ensure it fits properly
        RenderTextEllipsis(window->DrawList, bb.Min + style.FramePadding, ImVec2(value_x2, bb.Max.y), value_x2, value_x2, preview_value, NULL, NULL);
    }
    if (label_size.x > 0)
...
bool ImGui::BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags)
{
    ...
    // Custom popup styling: gradient background + subtle border to match combo frame
    {
        ...
        ImVec4 border_col = ImVec4(178 / 255.0f, 102 / 255.0f, 255 / 255.0f, 1.0f); // Purple border
...
bool ImGui::Combo(const char* label, int* current_item, const char* (*getter)(void* user_data, int idx), void* user_data, int items_count, int popup_max_height_in_items)
{
    ...
    const ImU32 header_col = ImColor(65, 30, 80, 255); // Purple-tinted header
    const ImU32 header_hovered = ImColor(95, 45, 120, 255); // Purple-tinted hover
    const ImU32 header_active = ImColor(120, 55, 150, 255); // Purple-tinted active
    ...
    while (clipper.Step())
        for (int i = clipper.DisplayStart; i < clipper.DisplayEnd; i++)
        {
            ...
            if (item_selected)
                ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(0.70f, 0.40f, 1.0f, 1.0f)); // Purple text for selected
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    struct SliderAnimState { ImVec4 currentBorderColor = ImVec4(153 / 255.0f, 102 / 255.0f, 204 / 255.0f, 1.0f); float animationSpeed = 2.0f; };
    ...
    {
        // Purple, opaque fill for the progressed portion of the track
        ImU32 fill_col = ImColor(178, 102, 255, 230); // Purple fill
